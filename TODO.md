...
- [ ] `brazil/aml-coaf.md` — BCB Resoluções 350/2025, 351/2025, 352/2025, 353/2025, 354/2025, 355/2025 (the PSAV regulatory framework). COAF reporting obligations (Lei 9.613/98 + Circular BCB). Suspicious activity reporting thresholds and timelines.
...
- [ ] GDPR Art. 17 on-chain erasure reconciliation — verify against EDPB Guidelines on blockchain (2024 draft + final if released by current calendar version).
...
- [ ] OFAC Tornado Cash precedent — FAQs 559/560/561/646 + 11th Circuit Van Loon ruling + any subsequent action.
- [ ] CVM Parecer de Orientação 40 token classification — current PO + Resolução 175.
- [ ] BCB Resoluções 350-355 série — current resoluções + Comunicados.
